...
public class Metodos {
    //-------------------------------------- Clientes----------------------
public LinkedList<Cliente> registrarCliente(
...
//------------------------------ VEHICULO--------------------
// ------------------registrar vehiculo
public LinkedList<vehiculo> registrarVehiculo(
    ...
    if (tipo == 1) {
        ...
        String combustible =
                v.validarCombustible(sc);

        System.out.println(
                "Ingrese la transmision:");

        String transmision =
                v.validarTransmision(sc);
        ...
        System.out.println(
                "Carro Sedan registrado correctamente.");
        ...
        String traccion =
                v.validarTraccion(sc);

        System.out.println(
                "Ingrese la capacidad del maletero:");
        ...
        System.out.println(
                "Camioneta SUV registrada correctamente.");
...
//-----------------------------------modificar vehiculo-----------------------------------------------
public LinkedList<vehiculo> modificarVehiculo(
        LinkedList<vehiculo> vehiculos,
        Scanner sc) {
    ...
    for (vehiculo v : vehiculos) {
        ...
        if (v.getPlaca().equalsIgnoreCase(placa)) {
            ...
            if (v instanceof CarroSedan) {
                ...
                carro.setTipoCombustible(
                        val.validarCombustible(sc));

                System.out.println(
                        "Nueva transmision:");

                carro.setTransmision(
                        val.validarTransmision(sc));
                ...
                suv.setTraccion(
                        val.validarTraccion(sc));

                System.out.println(
                        "Nueva capacidad del maletero:");

                suv.setCapacidadMaletero(
                        val.validarFloat(sc));
            }
...
public LinkedList<ContratoRenting> registrarContrato(
    ...
    for (ContratoRenting c : contratos) {
        ...
        if (c.getIdContrato()
            ...
            System.out.println(
                    "Ya existe un contrato con ese ID.");
    ...
    if (vehiculoEncontrado.getEstado()
    ...
    System.out.println(
            "Ingrese total de dias:");

    int dias =
            val.validarEntero(sc);

    contrato.setTotalDias(dias);

    float valorTotal =
            vehiculoEncontrado.getPrecioDiario()
                    * dias;

    contrato.setValorTotal(valorTotal);

    vehiculoEncontrado.setEstado(
            "Alquilado");
...
public LinkedList<ContratoRenting> modificarContrato(
    ...
    System.out.println(
            "Ingrese el ID del contrato a modificar:");
    ...
    for (ContratoRenting c : contratos) {
        ...
        if (c.getIdContrato()
            ...
            System.out.println(
                    "Nueva fecha inicio (dd/MM/yyyy):");

            String fechaInicio =
                    val.validarFecha(sc);

            System.out.println(
                    "Nueva fecha fin (dd/MM/yyyy):");
            ...
            while (dias <= 0) {
                ...
                System.out.println(
                        "Los dias deben ser mayores a cero");
            ...
            float valorTotal =
                    vehiculoContrato.getPrecioDiario()
                            * dias;
